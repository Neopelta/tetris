  ...
  &&lbl_GRAB_WITH_LOCID,
  &&lbl_CLOSURE_WITH_LOCID,
  &&lbl_CLOSUREREC_WITH_LOCID,
  &&lbl_MAKEBLOCK_WITH_LOCID,
  &&lbl_MAKEBLOCK1_WITH_LOCID,
  &&lbl_MAKEBLOCK2_WITH_LOCID,
  &&lbl_MAKEBLOCK3_WITH_LOCID,
  &&lbl_MAKEFLOATBLOCK_WITH_LOCID,
  &&lbl_GETFLOATFIELD_WITH_LOCID,
  &&lbl_C_CALL1_WITH_LOCID,
  &&lbl_C_CALL2_WITH_LOCID,
  &&lbl_C_CALL3_WITH_LOCID,
  &&lbl_C_CALL4_WITH_LOCID,
  &&lbl_C_CALL5_WITH_LOCID,
  &&lbl_C_CALLN_WITH_LOCID,
